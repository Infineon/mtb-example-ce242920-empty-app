# PSOC&trade; Control C1: Empty application template

This is a minimal starter application template for PSOC&trade; Control C1 MCU devices.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242920-empty-app)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[Empty App](https://github.com/Infineon/mtb-example-ce242920-empty-app)" application with the desired name "MyEmptyApp" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242920-empty-app --user-app-name MyEmptyApp --target-dir "C:/mtb_projects"
   ```
...
Document title: *CE242920* – *PSOC&trade; Control C1: Empty application template*
